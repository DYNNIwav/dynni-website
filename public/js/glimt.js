...
(function () {
  ...
  var FRAG = [
    ...
    '  float curtains = fbm(vec2(uv.x*6.0 - t*0.6 + flow*1.6, uv.y*1.4 + t*0.1));',
    '  float topMask = smoothstep(0.05, 0.85, uv.y);',
    '  float intensity = pow(curtains, 1.7) * topMask;',
    '  intensity *= 0.78 + 0.22*sin(u_time*0.5);',
